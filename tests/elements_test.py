...
class TestElements:
    ...
    class TestCheckBox:
        ...
        def test_check_box(self, driver):
            check_box_page=pages.elements_page.CheckBoxPage(driver, 'https://demoqa.com/checkbox')
            check_box_page.open()
    ...
    class TestRadioButton:
        def test_radio_button(self, driver):
            radio_button_page=pages.elements_page.RadioButtonPage(driver, 'https://demoqa.com/radio-button')
    ...
    class TestWebTable:
        ...
        def test_web_table_add_person(self, driver):
            web_table_page=pages.elements_page.WebTablePage(driver, 'https://demoqa.com/webtables')
            web_table_page.open()
    ...
    class TestButtonsPage:
        def test_different_click_on_the_buttons(self, driver):
            button_page=pages.elements_page.ButtonsPage(driver, 'https://demoqa.com/buttons')
            button_page.open()
